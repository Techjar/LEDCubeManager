...
import com.techjar.cubedesigner.hardware.animation.AnimationSpectrumAnalyzer;
import com.techjar.cubedesigner.hardware.tcp.Packet;
import com.techjar.cubedesigner.util.BufferHelper;
...
public class SpectrumAnalyzer {
    ...
    public void loadFile(File file) {
        try {
            ...
            CubeDesigner.getCommThread().getTcpServer().sendPacket(Packet.ID.AUDIO_INIT, getAudioInit());
            ...
            setVolume(CubeDesigner.getInstance().getScreenMainControl().volumeSlider.getValue());
    ...
    private class AnalyzerAudioListener implements AudioListener {
        ...
        public void samples(float[] floats) {
            Animation animation = CubeDesigner.getCommThread().getCurrentAnimation();
    ...
    private class StreamingAudioListener implements AudioListener {
        ...
        private void send(short[] samples) {
            ...
            CubeDesigner.getCommThread().getTcpServer().sendPacket(Packet.ID.AUDIO_DATA, buf.array());
        }
    }
}
